...
# from transformers.modeling_utils import SequenceClassifierOutputWithPast
from .configuration_rwkv import NGMERwkvConfig
...
class RwkvModel(RwkvPreTrainedModel):
    def __init__(self, config):
        ...
        self.embeddings = NGramsEmbedding(config.vocab_size, config.hidden_size)
    ...
    def forward(
        ...
        if inputs_embeds is None:
            ...
            inputs_embeds = self.embeddings(input_ids.permute(1, 0, 2).contiguous())
...
class RwkvForCausalLM(RwkvPreTrainedModel):
    ...
    def forward(
        ...
        if labels is not None:
            ...
            loss = self.loss_fct(
                ...
                n_hot_labels.view(-1, n_hot_labels.size(-1)),
            )
    ...
    def sample(
        ...
        **kwargs,
        ...
        from src.utils import ngme_sample
        return ngme_sample(self, input_ids, max_length=max_length)
...
#         else:
#             batch_size, sequence_length = inputs_embeds[:2]
#
